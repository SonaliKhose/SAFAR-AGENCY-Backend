...
const bookingRouter = require('../routes/bookings'); // Adjust the path as needed
const TravelBooking = require('../routes/travel'); // Adjust the path as needed
const auth = require('../middlewear/auth'); // Adjust the path as needed
...
describe('Booking Router', () => {
  ...
  beforeEach(async () => {
    // Create a sample booking before each test
    booking = await TravelBooking.create({
      bookingStatus: 'Pending',
      travelUserId: 'testUserId', // Required field
      email: 'test@example.com', // Required field
      name: 'Test Traveler', // Required field
